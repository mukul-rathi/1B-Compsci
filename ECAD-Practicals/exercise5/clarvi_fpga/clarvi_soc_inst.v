	clarvi_soc u0 (
		...
		.display_buttons_external_connection_export (<connected-to-display_buttons_external_connection_export>), // display_buttons_external_connection.export
		.leds_external_connection_export            (<connected-to-leds_external_connection_export>),            //            leds_external_connection.export
		.left_dial_external_connection_export       (<connected-to-left_dial_external_connection_export>),       //       left_dial_external_connection.export
		...
		.right_dial_external_connection_export      (<connected-to-right_dial_external_connection_export>),      //      right_dial_external_connection.export
